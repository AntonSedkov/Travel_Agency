...
public class StatementSql {
    ...
    public static final String ACTIVATE_USER_EMAIL = "UPDATE users SET email_approved = true WHERE id_user = (?)";
    ...
    public static final String FIND_TOUR_BY_PURPOSE = "SELECT id_tour, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days,price, quantity_tours, description, image_path from tours where tour_purpose = (?)";
    public static final String FIND_TOUR_BY_COUNTRY = "SELECT id_tour, tour_purpose, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where country = (?)";
    public static final String FIND_TOUR_BY_HOTEL_NAME = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where hotel_name = (?)";
    public static final String FIND_TOUR_BY_HOTEL_STARS_BIGGER_THAN = "SELECT id_tour, tour_purpose, country, hotel_name, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where  hotel_stars >= (?)";
    public static final String FIND_TOUR_BY_TRANSPORT = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, date_start_sec, " +
    ...
    public static final String FIND_TOUR_BY_DATE_BIGGER_THAN = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where date_start_sec >= (?)";
    public static final String FIND_TOUR_BY_PRICE_LOWER_THAN = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where price <= (?)";
    public static final String FIND_TOUR_BY_DAYS_BIGGER_THAN = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "price, quantity_tours, description, image_path from tours where quantity_of_days >= (?)";
    public static final String FIND_TOUR_BY_QUANTITY_BIGGER_THAN = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, description, image_path from tours where quantity_tours >= (?)";
    public static final String FIND_TOUR_BY_PARAMETER = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where tour_purpose = (?) AND country = (?) AND " +
            "hotel_name = (?) AND hotel_stars >= (?) AND transport = (?) AND date_start_sec >= (?) AND quantity_of_days >= (?) " +
            "AND price >= (?) AND quantity_tours >= (?)";

    public static final String FIND_ALL_TOUR_ACTIVE = "SELECT id_tour, tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
            "quantity_of_days, price, quantity_tours, description, image_path from tours where quantity_tours >= 1";
    public static final String CREATE_TOUR = "INSERT INTO tours (tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec, " +
    ...
    public static final String FIND_TOUR_BY_ID = "SELECT tour_purpose, country, hotel_name, hotel_stars, transport, date_start_sec," +
    ...
    public static final String FIND_ALL_HOT_TOURS_INFO = "SELECT tours.id_tour, tours.tour_purpose, tours.country, tours.hotel_name," +
            "tours.hotel_stars, tours.transport, tours.date_start_sec, tours.quantity_of_days, tours.price, tours.quantity_of_days, " +
