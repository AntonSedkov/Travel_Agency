...
<body>
    ...
    <div class="container-fluid mt-5" style="background-color:lightseagreen">
        ...
        <c:choose>
            ...
            <c:when test="${empty toursbytypes}">
                <div class="section_tittle text-center">
            ...
            <c:otherwise>
                ...
                <c:forEach var="typeMapEntry" items="${toursbytypes}">
                                ...
                                <div class="card-deck">
                                    ...
                                    <c:forEach var="currentTypeTour" items="${typeMapEntry.value}">
                                        ...
                                        <form name="hotTourForm" method="post" action="controller">
                                            ...
                                            <input type="hidden" name="id_tour" value="${currentTypeTour.id}">
                                 ...
                                 <%----%>           <p class="card-text">${currentTypeTour.description}</p>
