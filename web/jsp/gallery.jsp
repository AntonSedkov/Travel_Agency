                        ...
                        <div class="card-columns">
                            <div class="card">
                                <a href="${pageContext.request.contextPath}/pics/gallery/gallery_1.jpg" class="gallery_img">
                                    <img src="${pageContext.request.contextPath}/pics/gallery/gallery_1.jpg" class="card-img-top" alt="">
                                </a>
                            </div>
                            <div class="card">
                                <a href="${pageContext.request.contextPath}/pics/gallery/gallery_3.jpg" class="gallery_img">
                                    <img src="${pageContext.request.contextPath}/pics/gallery/gallery_3.jpg" class="card-img-top" alt="">
                                </a>
                            </div>
                            <div class="card">
                                <a href="${pageContext.request.contextPath}/pics/gallery/gallery_2.jpg" class="gallery_img">
                                    <img src="${pageContext.request.contextPath}/pics/gallery/gallery_2.jpg" class="card-img-top" alt="">
                                </a>
                            </div>
                            <div class="card">
                                <a href="${pageContext.request.contextPath}/pics/gallery/gallery_4.jpg" class="gallery_img">
                                    <img src="${pageContext.request.contextPath}/pics/gallery/gallery_4.jpg" class="card-img-top" alt="">
                                </a>
                            </div>
                            <div class="card">
                                <a href="${pageContext.request.contextPath}/pics/gallery/gallery_5.jpg" class="gallery_img">
                                    <img src="${pageContext.request.contextPath}/pics/gallery/gallery_5.jpg" class="card-img-top" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
